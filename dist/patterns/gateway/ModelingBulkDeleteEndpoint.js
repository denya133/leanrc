(function() {
  ...
  module.exports = function(Module) {
    var CrudEndpointMixin, Endpoint, FuncG, GatewayInterface, InterfaceG, ModelingBulkDeleteEndpoint, UNAUTHORIZED, UPGRADE_REQUIRED, statuses;
    ({
      FuncG,
      InterfaceG,
      GatewayInterface,
    ...
    return ModelingBulkDeleteEndpoint = (function() {
      class ModelingBulkDeleteEndpoint extends Endpoint {};

      ModelingBulkDeleteEndpoint.inheritProtected();

      ModelingBulkDeleteEndpoint.include(CrudEndpointMixin);

      ModelingBulkDeleteEndpoint.module(Module);

      ModelingBulkDeleteEndpoint.public({
      ...
      ModelingBulkDeleteEndpoint.initialize();
