(function() {
  ...
  module.exports = function(Module) {
    var CrudEndpointMixin, Endpoint, FuncG, GatewayInterface, InterfaceG, ModelingListEndpoint, UNAUTHORIZED, UPGRADE_REQUIRED, joi, statuses;
    ({
      FuncG,
      InterfaceG,
      GatewayInterface,
    ...
    return ModelingListEndpoint = (function() {
      class ModelingListEndpoint extends Endpoint {};

      ModelingListEndpoint.inheritProtected();

      ModelingListEndpoint.include(CrudEndpointMixin);

      ModelingListEndpoint.module(Module);

      ModelingListEndpoint.public({
      ...
      ModelingListEndpoint.initialize();
