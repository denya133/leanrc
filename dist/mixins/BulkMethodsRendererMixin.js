(function() {
  ...
  module.exports = function(Module) {
    ...
    return Module.defineMixin(Mixin('BulkMethodsRendererMixin', function(BaseClass = Renderer) {
      return (function() {
        var _Class;
        ...
        _Class.public({
          bulkDelete: FuncG([String, String, AnyT], MaybeG(AnyT))
        }, {
          default: function(resource, action, aoData) {}
        });

        _Class.public({
          bulkDestroy: FuncG([String, String, AnyT], MaybeG(AnyT))
        }, {
          default: function(resource, action, aoData) {}
        });
        ...
        _Class.public(_Class.async({
          ...
          default: function*(...args) {
            ...
            if ((path != null) && (resourceName != null) && (action != null)) {
              ...
              return (yield Module.prototype.Promise.resolve((templates != null ? templates[templatePath] : void 0) != null ? templates != null ? (ref = templates[templatePath]) != null ? ref.call(resource, resourceName, action, aoData) : void 0 : void 0 : action === 'bulkDelete' || action === 'bulkDestroy' ? this[action].call(resource, resourceName, action, aoData, templatePath) : (yield this.super(...args))));
            } else {
              return aoData;
            }
          }
